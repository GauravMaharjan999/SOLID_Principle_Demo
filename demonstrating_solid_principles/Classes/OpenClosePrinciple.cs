...
namespace demonstrating_solid_principles.Classes.OpenClosePrinciple
{
    ...
    /*
     ...
     Here Authenticate class is open for extension ,
     but cannot be modified due to abstract property
     */
    public abstract class Authenticate
    {
        private string[] Users = ["ram", "sam", "john", "tom", "hari"];
        private string[] Emails = ["ram@gmail.com", "sam@gmail.com", "john@gmail.com", "tom@gmail.com", "hari@gmail.com"];
    ...
    public class Auth : Authenticate
    {
        ...
        public bool IsPastUser(UserInputs _inputs)
        {
            ...
            {
                "volk@gmail.com", "chael@gmail.com", "topuria@gmail.com", "islam@gmail.com", "gauravmaharjan@gmail.com"
            };
